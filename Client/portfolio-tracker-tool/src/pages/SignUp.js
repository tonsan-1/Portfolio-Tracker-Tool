                ...
                <div className="w-full bg-white rounded shadow-lg p-8 m-4 md:max-w-sm md:mx-auto">
                    ...
                    <form className="mb-4" onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4 md:w-full">
                            ...
                            <input ref={emailRef} className="w-full border rounded p-2 outline-none focus:shadow-outline" type="email" placeholder="Email" />
                        </div>
                        ...
                        <button disabled={isLoading} className="bg-green-500 hover:bg-green-700 text-white uppercase text-sm font-semibold px-4 py-2 rounded">Sign Up</button>
                        <p className='my-2'>Already have an account? <Link to="/signin">Sign In</Link></p>
                        {error &&
